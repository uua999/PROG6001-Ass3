...
public class Game {
    ...
    private void printWelcome() {
        ...
        System.out.println("objective of the game come here");
    ...
    public boolean processCommand(Command command) {
        ...
        if (command.isUnknown()) {
            System.out.println("*****************************************");
            System.out.println("I don't know what you mean... type help !");
            System.out.println("*****************************************");
            return false;
        }
...
//            Command command1= new Command("quit",null);
                ...
                System.out.println("OutSide the gate there is a monster , you need to kill monster to escape.");
                System.out.println("*****************************************");
